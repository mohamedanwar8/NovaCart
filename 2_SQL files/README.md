...
PostgreSQL (CTEs, subquery, window functions, percentile analysis) · Power BI (star schema modeling, DAX, Visuals) · Claude (synthetic data generation to imitate real world messy data)
